...
def server(input: Inputs, output: Outputs, session: Session):
    ...
    def _build_overview_matrix_row(r, all_years):
        ...
        return tags.tr(
            ...
            tags.td(r.get("uf") or "—", style="text-align:center; font-weight:700; color:var(--text-mid);"),
            tags.td(r.get("data_solicitacao") or "—", class_="date-cell", style="text-align:center;"),
            tags.td(r.get("data_entrada_pl") or "—", class_="date-cell", style="text-align:center;"),
            tags.td(tags.span(rede, class_=f"rede-pill {rede_class}"), style="text-align:center;"),
            tags.td(r.get("tensao") or "—", style="text-align:center;"),
            tags.td(tags.span(status_label, class_=status_class, title=status_real), style="text-align:center;"),
            tags.td(r.get("data_emissao_pl") or "—", class_="date-cell", style="text-align:center;"),
            tags.td(r.get("data_emissao_doc") or "—", class_="date-cell", style="text-align:center;"),
            tags.td(tags.span(viab, class_=_overview_viab_pill_class(viab)), style="text-align:center;"),
            *year_cells,
        )
                    ...
                    tags.table(
                        tags.thead(
                            tags.tr(
                                ...
                                tags.th("Data Solic.", style="text-align:center; font-size:10px;", rowspan="2"),
                                tags.th("Entrada PL", style="text-align:center; font-size:10px;", rowspan="2"),
                                tags.th("Rede", style="text-align:center;", rowspan="2"),
                                tags.th("kV", style="text-align:center;", rowspan="2"),
                                tags.th("Status", style="text-align:center;", rowspan="2"),
                                tags.th("Emissão PL", style="text-align:center; font-size:10px;", rowspan="2"),
                                tags.th("Emissão Doc.", style="text-align:center; font-size:10px;", rowspan="2"),
                                tags.th("Viabilidade", style="text-align:center;", rowspan="2"),
                                *year_group_ths,
                            ),
                            tags.tr(*year_sub_ths),
                        ),
                        tags.tbody(*[_build_overview_matrix_row(r, all_years) for r in rows]),
                        class_="dc-matrix-table",
                    ),
        ...
        return tags.table(
            tags.thead(
                tags.tr(
                    ...
                    tags.th("Entrada PL", style="text-align:center; font-size:10px;", rowspan="2",
                            title="Data de chegada na PL para análise técnica"),
                    tags.th("Prazo PL", style="text-align:center; font-size:10px;", rowspan="2",
                            title="Prazo Análise Técnica PL"),
                    tags.th("Prazo ONS", style="text-align:center; font-size:10px;", rowspan="2",
                            title="Prazo Emissão PA - ONS"),
                    tags.th("Rede", style="text-align:center;", rowspan="2"),
                    tags.th("kV", style="text-align:center;", rowspan="2"),
                    tags.th("Status", style="text-align:center;", rowspan="2"),
                    tags.th("Emissão PL", style="text-align:center; font-size:10px;", rowspan="2"),
                    tags.th("Emissão Doc.", style="text-align:center; font-size:10px;", rowspan="2"),
                    tags.th("Prazo CUST", style="text-align:center; font-size:10px;", rowspan="2"),
                    tags.th("CUST", style="text-align:center; font-size:10px;", rowspan="2"),
                    tags.th("Viabilidade", style="text-align:center;", rowspan="2"),
                    *year_group_ths,
                ),
                tags.tr(*year_sub_ths),
