...
.viab-pill.viab-verificar { background: #DBEAFE; color: #1E40AF; border: 1px solid #93C5FD; }
...
.dc-matrix-table { width: 100%; border-collapse: collapse; border-spacing: 0; font-size: 12px; }
...
.dc-matrix-table thead tr:first-child th {
