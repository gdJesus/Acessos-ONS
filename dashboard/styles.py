...
/* Status pills */
.status-pill { display:inline-flex; padding:2px 8px; border-radius:10px; font-size:11px; font-weight:700; border:1px solid transparent; }
...
.status-miss { background:#FEE2E2; color:#991B1B; border-color:#FCA5A5; }
...
.viab-pill.viab-verificar { background: #FEF3C7; color: #92400E; border: 1px solid #FDE68A; }
.viab-pill.viab-no-prazo { background: #DBEAFE; color: #1E40AF; border: 1px solid #93C5FD; }
...
.rede-pill.rede-dist { background: #DBEAFE; color: #1E40AF; border-color: #93C5FD; }
.rede-pill.rede-rb { background: #FCE7F3; color: #9D174D; border-color: #F9A8D4; }
.rede-pill.rede-dit { background: #FEF3C7; color: #92400E; border-color: #FDE68A; }
.rede-pill.rede-empty { background: #F3F4F6; color: var(--text-dim); border-color: var(--border); }
